...
|---|--------|---------|------------|
| 1 | [[fstab-bind-mounts\|fstab-bind-mounts.sh]] | Add mount points and bind [[drives-and-mounts]] to /etc/[[drives-and-mounts]] | — |
| 2 | [[migrate-home-data\|migrate-home-data.sh]] | Copy user data (configs, SSH, etc.) from backup | (1) [[drives-and-mounts]] active |
| 3 | [[symlink-workspace\|symlink-workspace.sh]] | Create workspace symlinks on SSD storage | (1) [[drives-and-mounts]] active |
...
| Script | Purpose |
|--------|---------|
| [[live-env-setup\|live-env-setup.sh]] | CachyOS live ISO post-install — clones dotfiles, adds [[drives-and-mounts]], symlinks, bootstrap |
| [[REBUILD_SCRIPT\|REBUILD_SCRIPT.sh]] | Master 8-step rebuild — full system [[QUICK-START]] from backup |
| [[healthcheck\|healthcheck.sh]] | System [[health]] check — GPUs, [[drives-and-mounts]], services |
...
| [[check-fixes\|check-fixes.sh]] | Quality gate — tracks upstream KDE [[bugs-and-workarounds]], blocks updates within cooldown |
