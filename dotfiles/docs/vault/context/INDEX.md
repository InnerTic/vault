...
| File | Description |
|------|-------------|
| **[[system-memory]]** | **START HERE.** Merged AI reference — actual [[drives-and-mounts]], [[drives-and-mounts]], UUIDs, aliases, GW2, network, rebuild quick-ref. Updated 2026-05-10. |
...
| [[kde-workarounds]] | Tracked KDE [[bugs-and-workarounds]] with workarounds & review-by dates |
