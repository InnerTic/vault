...
# Canonical workflow from chat with Monday Kitsune (2026-04-19)
#
# ⚠️ HISTORICAL — This was a plan document from before the storage layout was
# implemented. The actual mount points, bind mounts, and drive assignments
# differ from what's described here. The implementation was completed with
# different drive labels and paths.
# See: /mnt/workspace/docs/system_profile_summary.txt (current)
# Archived: 2026-05-13
...
echo "UUID=UUID_HERE /mnt/ssd_storage ext4 defaults 0 2" | sudo tee -a /etc/[[drives-and-mounts]]
echo "/mnt/ssd_storage/home/ken/Documents /home/ken/Documents none bind 0 0" | sudo tee -a /etc/[[drives-and-mounts]]
echo "/mnt/ssd_storage/home/ken/Downloads /home/ken/Downloads none bind 0 0" | sudo tee -a /etc/[[drives-and-mounts]]
echo "/mnt/ssd_storage/home/ken/Pictures /home/ken/Pictures none bind 0 0" | sudo tee -a /etc/[[drives-and-mounts]]
echo "/mnt/ssd_storage/home/ken/Videos /home/ken/Videos none bind 0 0" | sudo tee -a /etc/[[drives-and-mounts]]
