...
| File | Score | Notes |
|------|-------|-------|
| `docs/context/system-memory.md` | **75** | [[core-baseline]] reference. Updated 2026-06-21. Drive UUIDs and [[drives-and-mounts]] unverifiable from non-root shell. |
...
| File | Score | Notes |
|------|-------|-------|
| `docs/vault/reference/glossary.md` | **75** | Term [[glossary]] — stable content. |
...
| `docs/vault/system/dual-boot-recovery.md` | **75** | Boot [[QUICK-START]] — Debian/MX Linux dual boot. |
