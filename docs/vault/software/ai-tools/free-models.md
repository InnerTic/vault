...
|-------|---------|----------|
| `big-pickle` | 200K | Stealth model. Best general-purpose. 128K output, tools, reasoning. |
| `nemotron-3-super-free` | 262K | NVIDIA 120B MoE (12B active). Strongest for agents, code, complex tasks. |
| `ring-2.6-1t-free` | 262K | InclusionAI 1T MoE. General-purpose, tools. |
...
| `cognitivecomputations/dolphin-mistral-24b-venice-edition:free` | 33K | Uncensored, dolphin fine-tune |
