...
> **⚠️ HISTORICAL — STALE INFORMATION**
> This document describes the *original planned* drive layout which was never fully implemented.
> Drive labels/sizes do NOT match current system.
> - Claims sda=465GB (bulk data) → actually sda=119GB (OS root)
> - Claims sdd=112GB (/home) → currently on sdd=465GB
> - Claims nvme0n1=465GB (Steam) → actually nvme0n1=119GB
>
> **See `~/dotfiles/docs/context/system-memory.md` for the ACTUAL current drive layout with correct UUIDs and mount points.**
> Kept for reference only.
>
> *Last accurate: 2026-04-19. Marked HISTORICAL: 2026-05-13.*
...
| **sda** | 465GB | `/mnt/ssd_storage` | Bind mounts: Documents, Downloads, Pictures, Videos |
...
- **Bind mounts** keep bulk data (downloads, pics, docs) off OS drives = clean backups
...
- **CPU**: 2x 4-core Xeon (8 cores total)
- **RAM**: 112GB
