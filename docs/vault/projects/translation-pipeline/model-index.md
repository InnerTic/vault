...
**Evaluation: ★★★★☆** — Best dense model for 3060. Gemma-3 base, uncensored. **Use for:** editor fallback, glossary/continuity fallback.
...
**Evaluation: ★★★☆☆** — Solid general-purpose 7B. Useful as editor fallback or light tasks. Not specialized for translation pipeline.
...
| `gemma-4-26B-A4B-it-uncensored-Q4_K_M.gguf` | 16G | Uncensored instruct |
| `gemma-4-26B-A4B-it-Claude-Opus-Distill.q4_k_m.gguf` | 16G | Claude Opus distill |
| `supergemma4-26b-uncensored-fast-v2-Q4_K_M.gguf` | 16G | Uncensored fast variant |
