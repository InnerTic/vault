...
The core goal is not just translation quality, but:
...
- `glossary-approved.md` — authoritative translation terms
- `glossary-candidate.md` — newly discovered terms awaiting review

Includes full history tracking of changes.
...
Its core strength is not speed or fluency, but:
