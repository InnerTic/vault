...
source: dotfiles/scripts/test-cleanup-backups.sh
restorable: true
checksum: 3efec32aa2cdb5ac72335cc4f1fabcdb9740681da3948aea8be88a075bfb382e
...
```bash
vault-restore test-cleanup-backups
```
